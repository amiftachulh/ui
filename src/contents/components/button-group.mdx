---
title: Button Group
description: Button Group represents a set of related actions.
component: true
...
<TabsContent value="cli">
  <PackageRunner command="nore-ui-cli@latest add button-group" />
</TabsContent>
...
<ComponentSource name="button-group.ts" type="slot-recipe" />

<ComponentSource name="button-group.tsx" type="component" />
