...
<ComponentPreview name="sidebar-07" type="block" />
...
<ComponentPreview name="sidebar-header" type="block" />
...
<ComponentPreview name="sidebar-footer" type="block" />
...
<ComponentPreview name="sidebar-group" type="block" />

## Collapsible SidebarGroup

To make a `SidebarGroup` collapsible, wrap it in a `Collapsible`.

<ComponentPreview name="sidebar-group-collapsible" type="block" />
...
<ComponentPreview name="sidebar-group-action" type="block" />
...
<ComponentPreview name="sidebar-menu" type="block" />
...
<ComponentPreview name="sidebar-menu-action" type="block" />
...
<ComponentPreview name="sidebar-menu-sub" type="block" />

## Collapsible SidebarMenu

To make a `SidebarMenu` component collapsible, wrap it and the `SidebarMenuSub` components in a `Collapsible`.

<ComponentPreview name="sidebar-menu-collapsible" type="block" />

## SidebarMenuBadge

The `SidebarMenuBadge` component is used to render a badge within a `SidebarMenuItem`.

<ComponentPreview name="sidebar-menu-badge" type="block" />
...
<ComponentPreview name="sidebar-controlled" type="block" />
