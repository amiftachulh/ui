...
<Callout>
  **Note:** For the purpose of this demo, we have intentionally disabled browser validation to show
  how schema validation and form errors work in React Hook Form. It is recommended to add basic
  browser validation in your production code.
</Callout>

<ComponentPreview name="form-rhf-demo" />
...
<Callout>
  **Note:** This example uses `zod v3` for schema validation, but you can replace it with any other
  Standard Schema validation library supported by React Hook Form.
</Callout>
...
<ComponentPreview name="form-rhf-input" />
...
<ComponentPreview name="form-rhf-select" />

```tsx highlight="5,9,14"
<Controller
  name="language"
  control={form.control}
  render={({ field, fieldState }) => (
...
<ComponentPreview name="form-rhf-checkbox" />

```tsx highlight="8,10,14-16,29"
<Controller
  name="tasks"
  control={form.control}
  render={({ field, fieldState }) => (
...
<ComponentPreview name="form-rhf-radiogroup" />

```tsx highlight="8,11,19,25"
<Controller
  name="plan"
  control={form.control}
  render={({ field, fieldState }) => (
...
<ComponentPreview name="form-rhf-switch" />

```tsx highlight="5,11,16-17"
<Controller
  name="twoFactor"
  control={form.control}
  render={({ field, fieldState }) => (
...
<ComponentPreview name="form-rhf-complex" />
...
<ComponentPreview name="form-rhf-array" />
