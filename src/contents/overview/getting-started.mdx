...
- React Icons - Read the [installation guide](https://react-icons.github.io/react-icons). This is optional, but it is used in this documentation.
...
<FileTree defaultValue={["preset", "recipes", "slot-recipes", "src", "components", "ui"]}>
  <FileTreeItem name="preset" type="folder">
    <FileTreeItem name="recipes" type="folder">
      <FileTreeItem name="button.ts" />
      <FileTreeItem name="index.ts" />
      <FileTreeItem name="..." noIcon disabled />
    </FileTreeItem>
    <FileTreeItem name="slot-recipes" type="folder">
      <FileTreeItem name="accordion.ts" />
      <FileTreeItem name="index.ts" />
      <FileTreeItem name="..." noIcon disabled />
    </FileTreeItem>
    <FileTreeItem name="index.ts" />
    <FileTreeItem name="keyframes.ts" />
    <FileTreeItem name="semantic-tokens.ts" />
    <FileTreeItem name="utilities.ts" />
  </FileTreeItem>
  <FileTreeItem name="src" type="folder">
    <FileTreeItem name="components" type="folder">
      <FileTreeItem name="ui" type="folder">
        <FileTreeItem name="accordion.tsx" />
        <FileTreeItem name="button.tsx" />
        <FileTreeItem name="..." noIcon disabled />
      </FileTreeItem>
    </FileTreeItem>
    <FileTreeItem name="hooks" type="folder" />
    <FileTreeItem name="lib" type="folder" />
    <FileTreeItem name="..." noIcon disabled />
  </FileTreeItem>
  <FileTreeItem name="package.json" />
  <FileTreeItem name="panda.config.ts" />
...
<Step>Copy the animation helper into respective files.</Step>
...
<Alert
  variant="warning"
  description="We use jsxStyleProps: 'minimal' to avoid prop name conflicts with other headless components. If you don't have a problem with this, you can remove it. But make sure to check the prop names of the components."
/>
