...
export function LoginForm({ css, ...props }: React.ComponentProps<typeof styled.form>) {
  return (
    <styled.form css={{ display: "flex", flexDir: "column", gap: "6", ...css }} {...props}>
      ...
      >
        <styled.h1 css={{ textStyle: "2xl", fontWeight: "bold" }}>Login to your account</styled.h1>
        <styled.p css={{ color: "muted.fg", textStyle: "sm", textWrap: "balance" }}>
          Enter your email below to login to your account
        </styled.p>
      </styled.div>
      <styled.div css={{ display: "grid", gap: "6" }}>
        ...
        >
          <styled.span
            css={{ bg: "bg", color: "muted.fg", pos: "relative", zIndex: "10", px: "2" }}
          >
            Or continue with
          </styled.span>
        </styled.div>
