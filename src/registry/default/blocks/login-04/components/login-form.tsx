        ...
        >
          <styled.form css={{ p: "6", md: { p: "8" } }}>
            <styled.div css={{ display: "flex", flexDir: "column", gap: "6" }}>
              ...
              >
                <styled.h1 css={{ textStyle: "2xl", fontWeight: "bold" }}>Welcome back</styled.h1>
                <styled.p css={{ color: "muted.fg", textWrap: "balance" }}>
              ...
              >
                <Button variant="outline" type="button" css={{ w: "full" }}>
                  ...
                  <styled.span css={{ srOnly: true }}>Login with Apple</styled.span>
                </Button>
                <Button variant="outline" type="button" css={{ w: "full" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <styled.span css={{ srOnly: true }}>Login with Google</styled.span>
                </Button>
                <Button variant="outline" type="button" css={{ w: "full" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <styled.span css={{ srOnly: true }}>Login with Meta</styled.span>
                </Button>
              </styled.div>
