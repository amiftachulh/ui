...
import { LuGalleryVerticalEnd, LuMinus, LuPlus } from "react-icons/lu";
        ...
        <SidebarGroup>
          <SidebarMenu>
            {data.navMain.map((item, index) => (
              <Collapsible key={item.title} defaultOpen={index === 1} className="collapsible">
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton>
                      ...
                      <LuPlus
                        className={css({
                          ml: "auto",
                          ".collapsible[data-state=open] &": { display: "none" },
                        })}
                      />
                      <LuMinus
                        className={css({
                          ml: "auto",
                          ".collapsible[data-state=closed] &": { display: "none" },
                        })}
                      />
                    </SidebarMenuButton>
                  </CollapsibleTrigger>
