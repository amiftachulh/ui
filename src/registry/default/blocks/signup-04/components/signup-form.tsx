        ...
        >
          <styled.form css={{ p: "6", md: { p: "8" } }}>
            <FieldGroup>
              ...
              <FieldSeparator css={{ "& > [data-slot=field-separator-content]": { bg: "card" } }}>
                Or continue with
              </FieldSeparator>
              <Field css={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "4" }}>
                <Button variant="outline" type="button">
                  ...
                  <styled.span css={{ srOnly: true }}>Sign up with Apple</styled.span>
                </Button>
                <Button variant="outline" type="button">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <styled.span css={{ srOnly: true }}>Sign up with Google</styled.span>
                </Button>
                <Button variant="outline" type="button">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  <styled.span css={{ srOnly: true }}>Sign up with Meta</styled.span>
                </Button>
              </Field>
