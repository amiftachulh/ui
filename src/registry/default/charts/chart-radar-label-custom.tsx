              ...
              tick={({ x, y, textAnchor, index, ...props }) => {
                ...
                return (
                  <text
                    ...
                    {...props}
                  >
                    <styled.tspan css={{ fill: "fg" }}>{data.desktop}</styled.tspan>
                    <styled.tspan css={{ fill: "muted.fg" }}>/</styled.tspan>
                    <styled.tspan css={{ fill: "fg" }}>{data.mobile}</styled.tspan>
                    <styled.tspan x={x} dy="1rem" fontSize={12} css={{ fill: "muted.fg" }}>
                      {data.month}
                    </styled.tspan>
                  </text>
                );
